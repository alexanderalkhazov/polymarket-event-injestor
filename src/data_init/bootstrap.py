...
HYPOTHESES = [
    ...
    },
    {
        ...
        "feature_conditions": {"poly_conviction_delta_1h": {"gt": 0.02}},
        "hold_days": 5,
    ...
    },
    {
        ...
        "feature_conditions": {"poly_conviction_delta_1h": {"lt": -0.02}},
        "hold_days": 5,
        "confidence_threshold": 0.50,
        "direction": "down",
        "invalidation_conditions": {},
    ...
    # ── New analytics signal hypotheses ──────────────────────────────────────────
    {
        "name": "Stochastic Oversold Bounce",
        "description": "Stochastic %K below 20 signals deep oversold momentum exhaustion — high-probability mean-reversion",
        "feature_conditions": {"stoch_k": {"lt": 22}},
        "hold_days": 5,
        "confidence_threshold": 0.60,
        "direction": "up",
        "invalidation_conditions": {"stoch_k": {"gt": 55}},
    },
    {
        "name": "Stochastic Overbought Reversal",
        "description": "Stochastic %K above 80 signals overbought exhaustion — mean-reversion short setup",
        "feature_conditions": {"stoch_k": {"gt": 78}},
        "hold_days": 5,
        "confidence_threshold": 0.60,
        "direction": "down",
        "invalidation_conditions": {"stoch_k": {"lt": 45}},
    },
    {
        "name": "52-Week High Breakout",
        "description": "Price within 3% of 52W high on elevated volume signals institutional accumulation and potential new high run",
        "feature_conditions": {"price_vs_52w_high": {"gt": 0.96}},
        "hold_days": 5,
        "confidence_threshold": 0.60,
        "direction": "up",
        "invalidation_conditions": {"price_vs_52w_high": {"lt": 0.90}},
    },
    {
        "name": "MACD Bullish Momentum",
        "description": "Positive MACD histogram confirms bulls control short-term price action — trend continuation",
        "feature_conditions": {"macd_histogram": {"gt": 0.003}},
        "hold_days": 5,
        "confidence_threshold": 0.60,
        "direction": "up",
        "invalidation_conditions": {"macd_histogram": {"lt": -0.01}},
    },
    {
        "name": "MACD Bearish Momentum",
        "description": "Negative MACD histogram confirms bears control short-term price action — trend continuation short",
        "feature_conditions": {"macd_histogram": {"lt": -0.003}},
        "hold_days": 5,
        "confidence_threshold": 0.60,
        "direction": "down",
        "invalidation_conditions": {"macd_histogram": {"gt": 0.01}},
    },
    {
        "name": "BB Deep Oversold Bounce",
        "description": "Price in bottom 15% of Bollinger Band range — statistically extreme oversold; snap-back expected",
        "feature_conditions": {"bb_position": {"lt": 0.15}},
        "hold_days": 3,
        "confidence_threshold": 0.58,
        "direction": "up",
        "invalidation_conditions": {"bb_position": {"gt": 0.55}},
    },
    # Broad directional catch-alls — match any signal above confidence threshold that
    # has a clear direction. Placed last so specific hypotheses take priority.
    {
        "name": "Directional Momentum Up",
        "description": "Multi-factor upward signal above confidence threshold — no single dominant feature",
        "feature_conditions": {"_signal_direction_up": {"gt": 0}},
        "hold_days": 5,
    ...
    {
        "name": "Directional Momentum Down",
        "description": "Multi-factor downward signal above confidence threshold — no single dominant feature",
        "feature_conditions": {"_signal_direction_down": {"gt": 0}},
        "hold_days": 5,
        "confidence_threshold": 0.55,
        "direction": "down",
        "invalidation_conditions": {},
