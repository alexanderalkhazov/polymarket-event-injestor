...
class KafkaConfig:
    ...
    group_id: str = "polymarket-consumer"
...
class AppConfig:
    ...
    consumer_pipeline: str = "polymarket"
...
def load_config() -> AppConfig:
    ...
    kafka = KafkaConfig(
        ...
        topics=_get_env("KAFKA_TOPICS", "polymarket-events"),
        group_id=_get_env("KAFKA_GROUP_ID", "polymarket-consumer"),
    ...
    return AppConfig(
        ...
        consumer_pipeline=_get_env("CONSUMER_PIPELINE", "polymarket").strip().lower(),
    )
